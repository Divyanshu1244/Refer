...
FORCE_CHANNEL_1 = "KHELO_INDIANS"  # Removed @ from username
...
def force_buttons():
    return InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("✅ Join Channel 1", url=f"https://t.me/{FORCE_CHANNEL_1}")],  # Updated to use FORCE_CHANNEL_1 directly
